all: main.cpp GameMaster.cpp Plansza.cpp Pole.cpp Gracz.cpp
	g++ -Wall -pedantic -mwindows main.cpp ikona.o GameMaster.cpp Plansza.cpp Pole.cpp Gracz.cpp -IC:\\Users\\r0ck\\Desktop\\SFML-2.4.0\\include -LC:\\Users\\r0ck\\Desktop\\SFML-2.4.0\\lib -lsfml-graphics -lsfml-window -lsfml-system
